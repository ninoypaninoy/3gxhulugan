...
(function(global, $) {
    ...
    dyscrollup.createBtn = function () {
        ...
        //add the button
        html = "<a id='dyscrollup-btn' class='animated bounceIn' href='#'></a>";
        $("body").prepend(html);
    ...
    dyscrollup.onscroll = function () {
        ...
        $(window).on("scroll", function(e) {
			if ( $(window).scrollTop() > self.option.showafter ) {
                ...
                $('a#dyscrollup-btn').addClass('animated bounceIn');

			} else {
				$('a#dyscrollup-btn').fadeOut();
                $('a#dyscrollup-btn').removeClass();
			}
		});
    };
